...
urlpatterns = [
    ...
    path('change-plan/', views.choose_plan_view, name='change-plan'), #same view as choose
    path('cancel-plan/', views.cancel_plan_view, name='cancel-plan'), #same view as choose
